...
test("endtoend", async ({ page }) => {
    ...
    await page.route("https://rahulshettyacademy.com/api/ecom/order/get-orders-for-customer/644e74af568c3e9fb160a8a7",
        async route => {
    ...
    await page.waitForResponse("https://rahulshettyacademy.com/api/ecom/order/get-orders-for-customer/644e74af568c3e9fb160a8a7")
